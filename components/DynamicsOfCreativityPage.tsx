...
function DynamicsOfCreativityPage() {
  const project = researchProjects.find(
    (project) => project.name === "Dynamics of Creativity",
  );

  return (
    <div>
      <ResearchPage
        header="Dynamics of Creativity"
        currentSection="Dynamics of Creativity"
        mainContent={
      ...
      />
      <Image
        src={`${process.env.NEXT_PUBLIC_BASE_PATH || ''}/images/pickle-fountain.png`}
